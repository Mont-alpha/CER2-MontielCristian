...
class mensaje(models.Model):
    ...
    comunicado = models.CharField(max_length=1000,null=True)
    ...
    publicado_por = models.ForeignKey(User,on_delete=models.CASCADE,blank=True,null=True)
    modificado_por = models.ForeignKey(User,on_delete=models.CASCADE,related_name="modificado_por",blank=True,null=True)
